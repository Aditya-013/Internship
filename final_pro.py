...
n = 9
k = 5
arr = [1, 3, 50, 80, 100, 150, 200, 250, 300]

# arr = [99, 3, 95, 90, 96, 98, 93, 92, 95]
# f = open("non_uni/non_uni/alm1_10_5_11", "r")
# x=f.readlines()
# x=[i.strip("\n") for i in x]
...
print("_______________ Smallest amongst all the iterations _______________________")
print()
